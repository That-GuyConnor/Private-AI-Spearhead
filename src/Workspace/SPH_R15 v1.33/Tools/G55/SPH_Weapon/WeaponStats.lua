...
-- Ammo
wepStats.ammoType = ".50 BMG" -- Gun shell models can be found in ReplicatedStorage > SPH_Assets > Shells
...
wepStats.maxAmmoPool = 50 -- How much ammo can this gun hold?
...
wepStats.recoil = {
	...
	horizontal = 4, -- Horizontal recoil
	camShake = 6.9, -- Camera shake
...
wepStats.gunRecoil = {
	...
	horizontal = 25, -- Horizontal recoil
