...
--< Gun settings >--
wepStats.fireRate = 700
wepStats.muzzleChance = 3 -- Number from 0-10 that determines how often the muzzle will flash when firing
wepStats.muzzleVelocity = 350 -- this stat uses meters per second
wepStats.aimSpeed = 0.3 -- 0-1 how much should the aim speed be multiplied by
wepStats.gunLength = 2.8 -- How close you can get to a surface before the viewmodel moves back
wepStats.maxPushback = 0.5 -- How far can the viewmodel move backwards until the gun is blocked
...
wepStats.startAmmoPool = 250 -- How much ammo should the gun start with?
wepStats.maxAmmoPool = 250 -- How much ammo can this gun hold?
...
-- Viewmodel
wepStats.viewmodelOffset = CFrame.new(-0.25,0.1,-0.2) -- Where should the viewmodel be placed in reference to the camera
...
wepStats.sprintAnim = "SMG_Sprint"
wepStats.reloadAnim = "SMG_Reload"
wepStats.emptyReloadAnim = "SMG_Reload2"
wepStats.boltChamber = "SMG_Chamber" -- Plays if the bolt is closed
wepStats.equipAnim = "Rifle_Equip"
wepStats.patrolAnim = "SMG_Neutral"
wepStats.holdUpAnim = "SMG_Neutral"
...
wepStats.emptyLockBolt = false -- Lock the bolt back after firing last round
...
-- Gun recoil
wepStats.gunRecoil = {
	vertical = 9, -- Vertical recoil
	horizontal = 1.5, -- Horizontal recoil
	damping = 2.5, -- How "springy" should the recoil be
	speed = 5.5, -- How quickly the recoil force will be recovered from
