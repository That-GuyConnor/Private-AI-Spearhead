...
wepStats.Bipod = false -- SPH_R15: Bipod

wepStats.SightAtt 		= "EOTech (White)"
wepStats.BarrelAtt		= ""
wepStats.UnderBarrelAtt = "Bipod"
wepStats.OtherAtt 		= ""
wepStats.AmmoAtt		= ""
...
-- Ammo
wepStats.ammoType = "7.62×51mm" -- Gun shell models can be found in ReplicatedStorage > SPH_Assets > Shells
...
-- Viewmodel
wepStats.viewmodelOffset = CFrame.new(-0.05,0.1,-0.2) -- Where should the viewmodel be placed in reference to the camera
...
wepStats.sprintAnim = "BoltRifle_Sprint"
