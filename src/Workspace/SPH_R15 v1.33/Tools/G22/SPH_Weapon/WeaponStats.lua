...
-- Ammo
wepStats.ammoType = ".40 S&W" -- Gun shell models can be found in ReplicatedStorage > SPH_Assets > Shells
...
wepStats.startAmmoPool = 60 -- How much ammo should the gun start with?
wepStats.maxAmmoPool = 75 -- How much ammo can this gun hold?
...
-- Camera recoil
wepStats.recoil = {
	vertical = 1.75, -- Vertical recoil
	horizontal = 1.75, -- Horizontal recoil
	camShake = 3, -- Camera shake
	damping = 1.5, -- How "springy" should the recoil be
	speed = 7.5, -- How quickly the recoil force will be recovered from
	aimReduction = 2 -- Recoil is divided by this when aiming
}

-- Gun recoil
wepStats.gunRecoil = {
	vertical = 7.5, -- Vertical recoil
	horizontal = 8, -- Horizontal recoil
