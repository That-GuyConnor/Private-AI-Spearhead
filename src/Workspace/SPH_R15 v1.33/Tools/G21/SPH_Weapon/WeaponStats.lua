...
wepStats.damage = {
	Head = 100,
	Torso = 35,
	Other = 25, -- Default damage if body part is not included
}
...
-- Ammo
wepStats.ammoType = ".45 ACP" -- Gun shell models can be found in ReplicatedStorage > SPH_Assets > Shells
wepStats.shellEject = true -- Should this gun eject shells?
wepStats.magazineCapacity = 13 -- Max ammo that can go in a mag
wepStats.arcadeAmmo = true -- Don't disable this until the new ammo system is added
wepStats.startAmmoPool = 65 -- How much ammo should the gun start with?
wepStats.maxAmmoPool = 78 -- How much ammo can this gun hold?
...
wepStats.recoil = {
	...
	speed = 7, -- How quickly the recoil force will be recovered from
	aimReduction = 2 -- Recoil is divided by this when aiming
}

-- Gun recoil
wepStats.gunRecoil = {
	vertical = 15, -- Vertical recoil
	horizontal = 7.5, -- Horizontal recoil
