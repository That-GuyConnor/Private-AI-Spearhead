...
wepStats.muzzleVelocity = 450 -- this stat uses meters per second
wepStats.aimSpeed = 0.3 -- 0-1 how much should the aim speed be multiplied by
wepStats.gunLength = 3 -- How close you can get to a surface before the viewmodel moves back
...
wepStats.magazineCapacity = 20 -- Max ammo that can go in a mag
...
wepStats.maxAmmoPool = 140 -- How much ammo can this gun hold?
