...
wepStats.muzzleVelocity = 200 -- this stat uses meters per second
...
wepStats.burstNumber = 5 -- If this gun can fire in bursts, what should the shot limit be?
wepStats.burstFireRate = 1500 -- Use this if you want a separate burst fire rate, leave it as nil if you want to use the regular fire rate
...
wepStats.startAmmoPool = 50 -- How much ammo should the gun start with?
wepStats.maxAmmoPool = 60 -- How much ammo can this gun hold?
...
wepStats.recoil = {
	...
	aimReduction = 1.5 -- Recoil is divided by this when aiming
}
