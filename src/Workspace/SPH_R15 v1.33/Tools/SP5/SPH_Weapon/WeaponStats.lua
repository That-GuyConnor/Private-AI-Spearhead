...
-- Gun recoil
wepStats.gunRecoil = {
	vertical = 12, -- Vertical recoil
	horizontal = 3, -- Horizontal recoil
	damping = 3, -- How "springy" should the recoil be
	speed = 3, -- How quickly the recoil force will be recovered from
