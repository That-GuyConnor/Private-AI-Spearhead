...
wepStats.muzzleVelocity = 460 -- this stat uses meters per second
...
wepStats.magazineCapacity = 17 -- Max ammo that can go in a mag
wepStats.arcadeAmmo = true -- Don't disable this until the new ammo system is added
wepStats.startAmmoPool = 85 -- How much ammo should the gun start with?
wepStats.maxAmmoPool = 102 -- How much ammo can this gun hold?
