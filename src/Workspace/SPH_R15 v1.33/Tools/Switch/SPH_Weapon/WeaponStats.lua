...
wepStats.burstNumber = 2 -- If this gun can fire in bursts, what should the shot limit be?
wepStats.burstFireRate = 1200 -- Use this if you want a separate burst fire rate, leave it as nil if you want to use the regular fire rate
...
wepStats.magazineCapacity = 33 -- Max ammo that can go in a mag
wepStats.arcadeAmmo = true -- Don't disable this until the new ammo system is added
wepStats.startAmmoPool = 99 -- How much ammo should the gun start with?
wepStats.maxAmmoPool = 99 -- How much ammo can this gun hold?
...
wepStats.rigParts = {"Mag","Bolt","Irons","Irons_SightGlow","FrontPost","SightGlow"} -- These parts will have their welds replaced with Motor6Ds in case they need to be animated
wepStats.fireMoveParts = {"Bolt","Irons","Irons_SightGlow","FrontPost","SightGlow"} -- These parts will move when firing
