...
module.ammoType 		= "Orange" -- what type of ammo does it eject?
module.tracers			= true
module.tracerTiming 	= 1 -- Every x number of shots will be a tracer
module.tracerColor 		= Color3.fromRGB(255, 170, 0)
