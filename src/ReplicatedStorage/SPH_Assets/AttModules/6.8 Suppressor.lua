...
--/Barrel
module.gunLength		= 0.3		-- how much length does this attachment add to the gun?
...
module.ammoType 		= nil -- what type of ammo does it eject?
module.tracers			= nil
module.tracerTiming 	= nil -- Every x number of shots will be a tracer
module.tracerColor 		= nil
...
module.muzzleChance 	= 0 -- Number from 0-10 that determines how often the muzzle will flash when firing
module.muzzleVelocity 	= nil -- this stat uses meters per second
