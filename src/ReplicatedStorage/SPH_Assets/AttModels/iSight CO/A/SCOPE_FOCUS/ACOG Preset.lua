...
Config.glassTransparency = 0.8 -- lower will have more zoom
Config.glassOffset = .8 -- z offset from scope part
Config.glassZoomFactor = .05 -- recommended 0.03 - 0.1

-- y = tan(x * focusSensitivity) / eyeboxCurve
-- https://www.desmos.com/calculator/z7r04qiqxm
Config.focusSensitivity = 6 -- sensitivity of lens focus/eye relief. higher magnification will be more sensitive
Config.eyeboxCurve = 4 -- exponential curve of which ocular lens shadow moves/increases

-- by default, eye relief/distance is perfectly centered from the AimPart's position. if you need to offset it change this
Config.eyeReliefOffset = -.05
