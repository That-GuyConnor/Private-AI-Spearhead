...
player.CharacterAdded:Connect(SetupSoundsForCharacter) -- SPH_R15: CharacterAppearanceLoaded doesn't play with R15 rigs for whatever reason, using CharacterAdded solves this
